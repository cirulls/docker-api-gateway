-- NEED CHANGE
-- -*- mode: lua; -*-
-- Generated on: 2016-04-04 15:52:41 +0000 --
-- Version:
...
service_123456789 = {
  ...
  -- CHANGE IT WITH YOUR SECRET TOKEN SET IN 3SCALE ADMIN PORTAL
  secret_token = '123456789abcdef'
}
...
-- CHANGE IT WITH YOUR API SERVICE ID IN 3SCALE ADMIN PORTAL
function extract_usage_123456789(request)
...
function get_debug_value()
  ...
  -- CHANGE IT WITH YOUR PROVIDER KEY IN 3SCALE ADMIN PORTAL
  if h["X-3scale-debug"] == '123456789abcdef' then
    return true
  else
    return false
  end
...
if ngx.var.service_id == '123456789' then
  ...
  -- CHANGE IT WITH YOUR API SERVICE ID IN 3SCALE ADMIN PORTAL
  get_credentials_app_id_app_key(params, service_123456789)
  -- CHANGE IT WITH YOUR API SERVICE ID IN 3SCALE ADMIN PORTAL
  ngx.var.cached_key = "123456789" .. ":" .. params.app_id ..":".. params.app_key
  auth_strat = "2"
  -- CHANGE IT WITH YOUR API SERVICE ID IN 3SCALE ADMIN PORTAL
  ngx.var.service_id = "123456789"
  -- CHANGE IT WITH THE DNS OF THE AWS EC2 INSTANCE WHERE THE API IS RUNNING
  ngx.var.proxy_pass = "http://backend_ec2-54-123-45-678.compute-1.amazonaws.com"
  -- CHANGE IT WITH YOUR API SERVICE ID IN 3SCALE ADMIN PORTAL
  ngx.var.usage = extract_usage_123456789(ngx.var.request)
end
